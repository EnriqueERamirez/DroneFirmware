...
const uint16_t INITIAL_HEIGHT = 500;  // Initial target height in millimeters
const uint16_t HEIGHT_INCREMENT = 100; // Height change increment in millimeters
const uint16_t MAX_HEIGHT = 1000;     // Maximum allowed height in millimeters
